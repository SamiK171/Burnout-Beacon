...
class Analysis:
    ...
    def weight_environment(self, data: list[int]) -> str:
        ...
        if weekly_avg >= 25: # in the case that no day weight >= 35
            return "HW"
        elif 15 <= weekly_avg <= 24:
    ...
    def develop_employee_state(self, e: Employee, period: str, period_type: str) -> tuple:
        ...
        diff_env, diff_vol, diff_dir = self.diff_environment(diff), self.task_diff_volatility(diff), self.comp_direction(diff)
